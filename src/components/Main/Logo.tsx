export default function Logo() {
  return (
    <>
      <h1 className='cursor-pointer relative text-5xl md:text-7xl xl:text-9xl font-extrabold text-yellow-400 dark:text-[#555a56] transform rotate-[-5deg] transition-transform duration-300 ease-out  drop-shadow-[4px_4px_0px_rgba(0,0,0,0.6)]  hover:scale-110 hover:rotate-0 hover:drop-shadow-[6px_6px_0px_rgba(0,0,0,0.8)]  mt-16 md:mt-16 xl:mt-24'>
        Poke<span className='text-red-500 dark:text-[#5e785d]'>Flip</span>
        <div className='absolute -bottom-5 -right-10 md:bottom-[-15px] md:right-[-50px] xl:-bottom-5 xl:right-[-70px]  w-12 h-12 md:w-16 md:h-16 xl:w-20 xl:h-20 bg-white border-4 border-black rounded-full flex items-center justify-center  shadow-xl transition-transform duration-300 hover:scale-110 cursor-pointer'>
          <div className='absolute w-full h-1/2 bg-red-500 top-0 rounded-t-full border-b-4 border-black dark:bg-[#333333]'></div>
